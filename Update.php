...
if (isset($_POST['done'])) {
	...
	$sql="UPDATE `table` SET id=$id,username='$name',password='$pws' where id=$id";
...
<body>
	<div class="col-lg-6 m-auto">
		...
		<div class="card">
		    ...
		    <input type="username" class="form-control" placeholder="Enter Username" name="username" value="<?php echo $name;?>">
		    <br>
